...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.tradehub.directory/browse",
  },
  openGraph: {
    title: "Browse All 5,085 Tradespeople | TradeHub",
    description:
      "Browse all 5,085 verified tradespeople across 22 categories in the West Midlands. Filter by trade, location, and rating.",
    url: "https://www.tradehub.directory/browse",
    siteName: "TradeHub",
    type: "website",
    images: [
      {
        url: "https://www.tradehub.directory/api/og?title=Browse+All+Tradespeople&subtitle=5%2C085+verified+professionals&count=5085",
        width: 1200,
        height: 630,
